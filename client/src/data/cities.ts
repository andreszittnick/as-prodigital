...
export const cities: Record<string, CityData> = {
  ...
  worms: {
    ...
    faqWebdesign: [
      { question: "Kann eine Agentur aus Alzey mein Webdesign-Projekt in Worms betreuen?", answer: "Absolut. Die Zusammenarbeit läuft bei AS-ProDigital hauptsächlich digital ab – per Video-Call, Telefon und E-Mail. Der Vorteil: nur ca. 25 km Entfernung und persönlicher Service. Bei Bedarf komme ich auch gerne zu Ihnen nach Worms." },
      { question: "Was kostet eine professionelle Website für mein Unternehmen in Worms?", answer: "AS-ProDigital bietet faire Preise – deutlich günstiger als klassische Agenturen in Worms, ohne Abstriche bei der Qualität. Kontaktieren Sie mich für ein kostenloses Erstgespräch und ein individuelles Angebot." },
  ...
  kaiserslautern: {
    ...
    seoDescription: "SEO Kaiserslautern: Bessere Google-Rankings für Ihr Unternehmen. ✓ Local SEO ✓ On-Page SEO ✓ Technisches SEO. Persönliche Betreuung ohne Agentur-Overhead.",
    ...
    faqWebdesign: [
      { question: "Warum AS-ProDigital aus Alzey statt einer lokalen Agentur in Kaiserslautern?", answer: "Lokale Agenturen in Kaiserslautern haben oft hohe Overheadkosten. Bei AS-ProDigital arbeiten Sie direkt mit mir – ohne Umwege, persönliche Betreuung von der ersten Idee bis zum Projekt, zu fairen Preisen." },
  ...
  bingen: {
    ...
    faqWebdesign: [
      { question: "Was kostet eine professionelle Website für mein Unternehmen in Bingen?", answer: "AS-ProDigital bietet transparente, faire Preise – deutlich günstiger als große Agenturen, ohne Abstriche bei Qualität. Vereinbaren Sie ein kostenloses Erstgespräch für ein individuelles Angebot." },
  ...
  "bad-kreuznach": {
    ...
    faqWebdesign: [
      ...
      { question: "Was kostet eine professionelle Website für meinen Betrieb in Bad Kreuznach?", answer: "Faire Preise, deutlich günstiger als viele Agenturen in der Region. Kontaktieren Sie mich für ein kostenloses Erstgespräch und ein individuelles Angebot." },
  ...
  mannheim: {
    ...
    webdesignDescription: "Professionelles Webdesign für Unternehmen in Mannheim – günstiger als lokale Mannheimer Agenturen, mit persönlichem Service. ✓ SEO-optimiert ✓ Faire Preise. Jetzt anfragen!",
    ...
    webdesignSection4: "Großstädte wie Mannheim haben den Nachteil, dass Agenturen vor Ort teuer sind – und den Vorteil, dass der digitale Markt groß ist. AS-ProDigital bringt Ihnen das Beste aus beiden Welten: die Qualität einer professionellen Webagentur und die fairen Preise eines persönlich geführten Betriebs. Kein Overhead, keine langen Entscheidungswege, kein Callcenter – direkte Zusammenarbeit mit dem Experten.",
    webdesignStats: [
    ...
    faqWebdesign: [
      { question: "Warum AS-ProDigital aus Alzey statt einer Mannheimer Webagentur?", answer: "Mannheimer Agenturen haben hohe Fixkosten, die sich in teuren Angeboten niederschlagen. Bei AS-ProDigital: direkter Kontakt, persönliche Betreuung, deutlich günstigere Preise – bei gleicher oder höherer Qualität." },
    ...
    faqSeo: [
      ...
      { question: "Was kostet SEO-Optimierung für ein Unternehmen in Mannheim?", answer: "Deutlich günstiger als Mannheimer Agenturen. Kontaktieren Sie mich für ein kostenloses Erstgespräch und ein individuelles Angebot." },
    ],
  },
};
