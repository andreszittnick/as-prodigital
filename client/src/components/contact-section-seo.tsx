      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 mb-4 sm:mb-6">
            Bereit für bessere <span className="gradient-text">Sichtbarkeit</span>?
          </h2>
          <p className="text-base sm:text-lg lg:text-xl text-slate-600 max-w-3xl mx-auto px-4 sm:px-0">
            Lassen Sie uns gemeinsam Ihre SEO-Strategie besprechen und den Weg zu mehr Sichtbarkeit definieren - Für Ihre erfolgreiche Online-Präsenz!
          </p>
        </motion.div>
