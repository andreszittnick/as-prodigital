...
export default function HeroSectionWebdesign() {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden dynamic-background">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 md:pt-28 lg:pt-32">
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
          ...
          >
            ...
            >
              <span className="gradient-text whitespace-nowrap">Modernes Webdesign</span><br />
              <span className="text-slate-900 whitespace-nowrap">aus Alzey, für Ihren</span><br />
