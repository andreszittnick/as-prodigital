...
import { CheckCircle, Monitor, Smartphone, Zap, Search, Phone, Mail, MapPin, ArrowRight, Star } from "lucide-react";
  ...
  const features = [
    {
      ...
      desc: `Individuelle Websites, die zu Ihrem Unternehmen in ${city.name} passen – kein Baukasten, kein Template.`,
    },
    {
      icon: Smartphone,
      title: "Responsive & Mobiloptimiert",
      desc: "Ihre Website sieht auf jedem Gerät perfekt aus – Smartphone, Tablet und Desktop.",
    },
    {
      icon: Zap,
      title: "Schnell & Performant",
      desc: "Ladezeiten unter 2 Sekunden. Schnelle Websites werden von Google bevorzugt und konvertieren besser.",
    },
    {
      icon: Search,
      title: "SEO von Anfang an",
      desc: `Jede Website wird von Grund auf für Suchmaschinen optimiert, damit Sie in ${city.name} gefunden werden.`,
    },
  ];

  const process = [
    { step: "01", title: "Kostenloses Erstgespräch", desc: "Wir besprechen Ihre Ziele, Zielgruppe und was Ihre Website leisten soll." },
    { step: "02", title: "Konzept & Design", desc: "Sie erhalten einen individuellen Entwurf – abgestimmt auf Ihr Unternehmen." },
    { step: "03", title: "Entwicklung & Umsetzung", desc: "Schnelle, saubere Entwicklung mit modernen Technologien." },
    { step: "04", title: "Launch & Betreuung", desc: "Ihre Website geht online – und ich stehe Ihnen auch danach zur Seite." },
  ];
          ...
          <div className="relative max-w-5xl mx-auto px-4 text-center">
            ...
            >
              ...
              <h1 className="text-3xl md:text-5xl font-bold text-[#19243b] dark:text-white mb-5 leading-tight">
                Professionelles{" "}
                <span className="text-[#fa5219]">Webdesign</span>{" "}
                in {city.name}
              </h1>
              <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto mb-8">
                Moderne, schnelle und SEO-optimierte Websites für Unternehmen in {city.nameFull} –
                {" "}{city.localFact}.
              </p>
              ...
              <div className="flex flex-wrap justify-center gap-6 mt-10 text-sm text-gray-500 dark:text-gray-400">
                {["Responsive Design", "SEO-optimiert", "Schnelle Ladezeiten", "Persönliche Beratung"].map(tag => (
          ...
          <div className="max-w-5xl mx-auto px-4">
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-300 max-w-xl mx-auto">
                Eine gute Website ist mehr als nur schönes Design – sie muss gefunden werden, überzeugen und Kunden gewinnen.
              </p>
            </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              >
                <h2 className="text-2xl md:text-3xl font-bold text-[#19243b] dark:text-white mb-5">
                  Warum AS-ProDigital für Webdesign in {city.name}?
                </h2>
                <div className="space-y-4">
                  {[
                    `Persönliche Beratung – kein Callcenter, sondern direkter Kontakt`,
                    `Webdesign aus einer Hand: Design, Entwicklung und SEO`,
                    `Transparente Preise ohne versteckte Kosten`,
                    `Schnelle Umsetzung: Von der Idee zur fertigen Website`,
                ...
                <div className="mt-8 flex items-center gap-3">
                  ...
                  <span className="text-sm text-gray-600 dark:text-gray-400">Kundenbewertungen aus der Region</span>
                </div>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, x: 20 }}
              ...
              >
                ...
                <div className="space-y-4 mb-6">
                  <a href="tel:+496731 8789" className="flex items-center gap-3 hover:text-[#fa5219] transition-colors">
        ...
        <section className="py-16 md:py-24 bg-gray-50 dark:bg-gray-800">
          <div className="max-w-4xl mx-auto px-4">
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-300">Einfacher Prozess, professionelles Ergebnis – in 4 Schritten zur fertigen Website.</p>
            </motion.div>
            <div className="grid sm:grid-cols-2 gap-6">
              {process.map((p, i) => (
                <motion.div
        ...
        <section className="py-14 bg-[#19243b]">
          <div className="max-w-4xl mx-auto px-4 text-center">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">
              Webdesign in {city.name} – mit SEO von Anfang an
            </h2>
            <p className="text-gray-300 max-w-2xl mx-auto mb-8">
              Wir bauen keine Websites ins Blaue. Jede Website, die bei AS-ProDigital entsteht, ist von Grund auf für Suchmaschinen optimiert –
              damit Ihre Kunden in {city.name} Sie auch bei Google finden.
            </p>
